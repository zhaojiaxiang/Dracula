...
class Projects(models.Model):
    ...
    fprojectnm = models.CharField(verbose_name='项目名称', max_length=50)
    fprojectsn = models.CharField(verbose_name='项目', max_length=10)
    fautoflg = models.CharField(verbose_name='自动生成联络票号', max_length=1)
