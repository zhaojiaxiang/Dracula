...
class Liaisons(models.Model):
    ...
    fodrno = models.CharField(verbose_name='订单号', max_length=20)
    ...
    fassignedto = models.CharField(verbose_name='对应者', max_length=60)
    fhelper = models.CharField(verbose_name='协助者', max_length=60, null=True, blank=True)
    fleader = models.CharField(verbose_name='负责人', max_length=60)
    ...
    freleaserpt = models.FileField(verbose_name='程序发布报告URL', upload_to='liaison/%Y%m%d/', null=True, blank=True)
