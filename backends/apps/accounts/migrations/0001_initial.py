    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='groups', to='rbac.Group')),
                ('roles', models.ManyToManyField(blank=True, related_name='roles', to='rbac.Role', verbose_name='拥有的所有角色')),
